...
```sql
SELECT * FROM TAB WHERE TNAME LIKE '%20231052';
SELECT * FROM DEPENDENT20231052;

DESC EMPLOYEE20231052;

DROP TABLE EMPLOYEE20231052 CASCADE CONSTRAINTS;
DROP TABLE DEPARTMENT20231052 CASCADE CONSTRAINTS;
DROP TABLE PROJECT20231052 CASCADE CONSTRAINTS;
DROP TABLE WORKS_ON20231052 CASCADE CONSTRAINTS;
DROP TABLE DEPT_LOCATIONS20231052 CASCADE CONSTRAINTS;
DROP TABLE DEPENDENT20231052 CASCADE CONSTRAINTS;

ALTER TABLE EMPLOYEE20231052 DROP CONSTRAINT DNO20231052;
DESC EMPLOYEE20231052;
...
**STEP 4: Create user**
```sql
CREATE USER myuser IDENTIFIED BY arpit;
```
...
```shell
sqlplus myuser/arpit@localhost:1521/XEPDB1
```
