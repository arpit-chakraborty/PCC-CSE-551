...
FROM EMPLOYEE20231052 E, DEPARTMENT20231052 D 
...
FROM EMPLOYEE20231052 E, DEPARTMENT20231052 D, PROJECT20231052 P 
...
FROM EMPLOYEE20231052 E, EMPLOYEE20231052 M
...
FROM PROJECT20231052 P, WORKS_ON20231052 W, EMPLOYEE20231052 E, DEPARTMENT20231052 D
WHERE 
...
FROM EMPLOYEE20231052 E, WORKS_ON20231052 W, PROJECT20231052 P
...
FROM EMPLOYEE20231052 E, WORKS_ON20231052 W, PROJECT20231052 P, DEPARTMENT20231052 D
...
FROM EMPLOYEE20231052 E, DEPENDENT20231052 DEP
...
FROM EMPLOYEE20231052
WHERE NOT EXISTS (
    (SELECT PNUMBER FROM PROJECT20231052 WHERE DNUM=5)
    MINUS
    (SELECT PNO FROM WORKS_ON20231052 WHERE ESSN=SSN)
);
```
...
WHERE SSN NOT IN 
(
	SELECT ESSN FROM DEPENDENT20231052
);
```
...
FROM EMPLOYEE20231052 GROUP BY DNO;
```
...
FROM PROJECT20231052 P, WORKS_ON20231052 W
...
```sql
CREATE VIEW EMP_PROJECT_VIEW20231052 AS
SELECT E.FNAME, E.LNAME, E.SSN, P.PNAME, P.PLOCATION, W.HOURS
FROM EMPLOYEE20231052 E, PROJECT20231052 P, WORKS_ON20231052 W
